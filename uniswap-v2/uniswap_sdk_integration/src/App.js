...
const WETH_TO_USDAO = async (INPUT_TOKEN = {}) => {
...
const USDAO_TO_WETH = async (INPUT_TOKEN = {}) => {
        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-sm">
                    <div className="card">
                        <div className="card-header">
                            Uniswap: Buy ERCTOKEN for ETH (KOVAN)
                      </div>
                        <div className="card-body">
                            ...
                            <div className="input-group">
                                ...
                                <button onClick={() => WETH_TO_USDAO(defiTokens["USDAO"])} className="btn btn-primary">ETH Amount</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-sm">
                    <div className="card">
                        <div className="card-header">
                            Uniswap: Buy ETH for ERCTokens (KOVAN)
                      </div>
                        <div className="card-body">
                            ...
                            <div className="input-group">
                                ...
                                <button onClick={() => USDAO_TO_WETH(defiTokens["USDAO"])} className="btn btn-primary">Token Amount</button>
                            </div>
                        </div>
                    </div>
                </div>
